...
public class fourthframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Q3- Which package contains the Random class?");

        jRadioButton1.setText("java.util.package");

        jRadioButton2.setText("java.lang.package");

        jRadioButton3.setText("java.awt.package");

        jRadioButton4.setText("java.io.package");
